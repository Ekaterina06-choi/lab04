...
Katya@ubuntu:~$ export GITHUB_TOKEN=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
...
Katya@ubuntu:~/Ekaterina06-choi/workspace$ git clone https://github.com/${GITHUB_USERNAME}/lab03 projects/lab04
...
remote: Total 91 (delta 21), reused 0 (delta 0), pack-reused 0 (from 0)
Receiving objects: 100% (91/91), 58.41 KiB | 934.00 KiB/s, done.
Resolving deltas: 100% (21/21), done.
Katya@ubuntu:~/Ekaterina06-choi/workspace$ cd projects/lab04/lab03
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ git remote remove origin
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ git remote add origin https://github.com/${GITHUB_USERNAME}/lab04
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ cat > .travis.yml <<EOF
> language: cpp
EOF
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ cat >> .travis.yml <<EOF
> 
...
> addons:
  apt:
    ...
    packages:
      ...
      - cmake-data
EOF
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ travis login --github-token ${GITHUB_TOKEN}
...
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ ex -sc '1i|<фрагмент_вставки_значка>' -cx README.md
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ git add .travis.yml
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ git add README.md
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ git commit -m"added CI"
[main d03ab27] added CI
 2 files changed, 15 insertions(+)
 create mode 100644 lab03/.travis.yml
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ git push origin master
error: src refspec master does not match any
error: failed to push some refs to 'https://github.com/Ekaterina06-choi/lab04'
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ git push origin main
...
Katya@ubuntu:~/Ekaterina06-choi/workspace/projects/lab04/lab03$ 
